# Apply Batch F5 v2 Candidate Field Kits Package
...
Copy-Item -Path "$env:USERPROFILE\Downloads\batch-f5-candidate-field-kits-package-v2.zip" -Destination ".\batch-f5-candidate-field-kits-package-v2.zip" -Force

Expand-Archive -Path ".\batch-f5-candidate-field-kits-package-v2.zip" -DestinationPath ".\" -Force

$pkg = "batch-f5-candidate-field-kits-package-v2"
...
Copy-Item -Path "$src\planning\\documentation-reusable-candidate\\examples\\SOURCE-USAGE-CASCADE-ENMAN-SCENARIO-EXAMPLE.md" -Destination ".\planning\\documentation-reusable-candidate\\examples\\SOURCE-USAGE-CASCADE-ENMAN-SCENARIO-EXAMPLE.md" -Force
...
$pkgName = "batch-f5-candidate-field-kits-package-v2"
