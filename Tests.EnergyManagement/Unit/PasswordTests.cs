...
{
    public abstract class PasswordTestsBase
    {
        protected ITestOutputHelper? _output;
        public PasswordTestsBase()
        {
        }
        public static IEnumerable<object[]> GetInvalidPasswordsWithoutSpecialCharacters()
        {
            ...
            yield return new object[] { "AnotOne2"
                , new List<Error> { Account.PasswordLacksSpecialCharacters,Account.PasswordIsTooShort} };
            yield return new object[] { InvalidTestData.LongPasswordWithoutSpecialChars
                , new List<Error> { Account.PasswordLacksSpecialCharacters,Account.PasswordIsTooLong } };
            
        }
        
        public void LogTwoErrorCollections(IEnumerable<Error> expected,
    ...
    public class PasswordTests:PasswordTestsBase
    {
