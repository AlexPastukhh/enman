...
namespace Tests.EnergyManagement.Integration.L1.Security;

[Collection("IntegrationTestCollection")]
public sealed class L1AntiforgeryIntegrationTests : L1IntegrationTestBase
{
    public L1AntiforgeryIntegrationTests(IntegrationTestFixture fixture, ITestOutputHelper output)
        : base(fixture, output)
    {
    }
    ...
    public async Task Logout_WithoutTokenReturnsAntiforgeryProblem_AndWithTokenSucceeds()
    {
        ...
        var missingTokenLogout = await missingTokenClient.PostAsync("/api/l1/auth/logout", content: null);
        ...
        var logout = await PostWithCsrfAsync(validTokenClient, "/api/l1/auth/logout");
