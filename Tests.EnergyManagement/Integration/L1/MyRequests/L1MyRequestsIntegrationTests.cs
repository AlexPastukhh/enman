...
namespace Tests.EnergyManagement.Integration.L1.MyRequests;

[Collection("IntegrationTestCollection")]
public sealed class L1MyRequestsIntegrationTests : L1IntegrationTestBase
{
    public L1MyRequestsIntegrationTests(IntegrationTestFixture fixture, ITestOutputHelper output)
        : base(fixture, output)
    {
    }
