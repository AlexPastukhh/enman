...
public sealed record MyRequestSummaryDto(
    ...
    [property: JsonPropertyName("objectAddress")] AddressDto ObjectAddress);
...
public sealed record MyRequestDetailsDto(
    ...
    [property: JsonPropertyName("status")] string Status,
    [property: JsonPropertyName("createdAt")] DateTimeOffset CreatedAt,
    [property: JsonPropertyName("submittedRequest")] SubmittedRequestDto SubmittedRequest,
    [property: JsonPropertyName("reviewResult")] MyRequestReviewResultDto? ReviewResult);

public sealed record SubmittedRequestDto(
    [property: JsonPropertyName("details")] string Details,
    [property: JsonPropertyName("objectAddress")] AddressDto ObjectAddress);

public sealed record MyRequestReviewResultDto(
    [property: JsonPropertyName("decision")] string Decision,
    [property: JsonPropertyName("decidedAt")] DateTimeOffset DecidedAt,
    [property: JsonPropertyName("rejection")] MyRequestRejectionDto? Rejection);

public sealed record MyRequestRejectionDto(
