...
| Reusable Tampermonkey full helper docs/implementation | `planning/documentation/tools/tampermonkey/README.md` and `planning/documentation/tools/tampermonkey/chat-command-palette.user.js` | Portable full helper docs/implementation copied with the reusable docs layer; projection only, not command authority. |
