...
Status: active Enman project profile  
Scope: concrete evidence/current-reality model and status vocabulary for Enman documentation reconciliation

## 1. Purpose

This file defines which evidence sources and status labels should be used when reconciling Enman documentation status claims.
