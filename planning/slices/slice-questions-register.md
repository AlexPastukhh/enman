...
| `SL-APPL-Q-002` | `SL-APPL-001` / `SL-APPL-003` | default | accepted | What happens to default on create? | First of type may initialize; additional same-type does not switch. |
...
| `SL-APPL-Q-005` | `SL-APPL-004` | service | accepted | Shared creation service? | Yes; service no SaveChanges. |
