...
| `CP-REQ-APPL-CONTEXT-001` | request API | explicit Existing/New applicant context. | implemented |
| `CP-REQ-APPL-PICKER-001` | request UI | future picker can choose any owned saved ApplicantParty. | future |
| `CP-REQ-APPL-ATOMIC-001` | transaction | New applicant + request committed together. | implemented |
