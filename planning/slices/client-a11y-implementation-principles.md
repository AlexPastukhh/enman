# Client Accessibility / ARIA Implementation Principles

Status: current client accessibility and ARIA implementation principles  
Scope: accessibility, ARIA and user-visible test contract for client slices
...
client slice draft Accessibility / ARIA Contract sections
```
