...
| `planning/ui/test-site-ui-plan.md` | `clean-ui-description.md`, `planning/thesis/presentation/slide-outline.md` | Страницы и действия пользовательского интерфейса | draft | UI-план использовать как основу описания интерфейса |
...
| Uploaded presentation examples | `planning/thesis/presentation/slide-outline.md`, `planning/thesis/presentation/speech-draft.md` | Типовая структура защиты: тема, цель, задачи, архитектура, БД, интерфейс, результаты | reference | Использовать только как ориентир структуры защиты |
