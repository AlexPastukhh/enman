...
- Unit tests should cover:
  ...
  - failure when a referenced aggregate is not persisted or has invalid default ID, where practical;
  - successful creation behavior only when valid IDs can be provided safely.
