...
After TM-REUSE-ONLY, this register records that the tracked Tampermonkey helper implementation moved fully into `planning/documentation/tools/tampermonkey/` and the old project-local helper files were removed from active tracked routing. After TM-REUSE-ONLY-FIX, active router/register/workstream references point to the reusable helper paths and old starter/local-helper rows are not active inventory.
...
| `planning/documentation/tools/tampermonkey/chat-command-palette.user.js` | reusable documentation-layer helper implementation | userscript @version 0.5.0 / no Doc version | reusable-only helper placement in TM-REUSE-ONLY | Full reusable helper lives in documentation layer; projection only, not command authority. |
...
Sources:
  ...
  Content:
    ...
    - planning/documentation/tools/tampermonkey/** @ current reusable helper placement
  Internal dependencies:
    - Register Rules
...
| `planning/documentation/tools/tampermonkey/chat-command-palette.user.js` | reusable-only full Tampermonkey helper | userscript @version 0.5.0 | reusable docs-layer helper placement | Projection only; commands remain owned by UCM/owner docs. |
...
| `planning/documentation/tampermonkey-command-projection-workflow.md` | reusable Tampermonkey projection rules | project root UCM; command owner workflows/templates; reusable helper docs/userscript; project-local tool forks only when explicitly adapted | reusable projection workflow | projection workflow Doc version: v0.2.0 | derived/synchronized in TM-REUSE-ONLY | reusable-only helper model active | Owns projection-only helper rules; project-local tools/workstreams do not own reusable command meaning. |
| `planning/documentation/tools/tampermonkey/README.md` | reusable full Tampermonkey helper README | `planning/documentation/tampermonkey-command-projection-workflow.md`; `planning/documentation/command-creation-workflow.md`; `planning/documentation/field-kits/root-use-case-map-field-kit.md`; `planning/documentation/tools/tampermonkey/chat-command-palette.user.js` | reusable helper docs | helper README Doc version: v0.2.0; projection workflow Doc version: v0.2.0; userscript @version 0.5.0 | derived/synchronized in TM-REUSE-ONLY | reusable-only helper model active | Copied with reusable docs layer; not command authority. |
...
| `planning/planning-use-case-map.md` / `planning/workstreams/tampermonkey-command-projection-plan.md` / `planning/documentation/tools/tampermonkey/chat-command-palette.user.js` | replacement archive guide + explicit review-diff workflow | Helper command profiles and root routes distinguish default clipboard diff from explicit review-diff-file mode. | candidate rows added after TM12D/DISC-GM-TM1 | Keep ordinary `давай архив` and explicit review-diff-file route separate. |
...
Source Delta:
  ...
  - Updated tracked versions for UCM v1.2.0, projection plan v0.6.0, helper README v0.2.0, userscript @version 0.5.0 and command-system Goal Map v0.4.0.
...
Changed files:
  ...
  - planning/documentation/tools/tampermonkey/README.md @ reusable full helper README
  - planning/documentation/tools/tampermonkey/chat-command-palette.user.js @ reusable full helper userscript
...
Reason:
  The copied reusable docs layer must contain the general Tampermonkey projection rules and reusable full helper implementation. Enman-specific workstream files remain local application/planning owners only.

Boundary:
  This does not change command semantics. It moves reusable ownership and the full helper into planning/documentation/.
```
