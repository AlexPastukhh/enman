...
| `planning/workstreams/slice-test-source-refactor-goal-map.md` | active slice/testing source-refactor living Goal Map | `planning/goal-map-principles-workflow-template.md`; `planning/planning-use-case-map.md`; `planning/source-cascade-sync-workflow.md`; `planning/slices/slice-source-sync-register.md`; `planning/testing/testing-source-sync-register.md`; versioned slice/testing owner docs | workstream state + audit/refactor navigation | map Doc version: v0.1.0; source-cascade workflow Doc version: v1.0.0; slice/testing registers Doc version: v0.2.0; root register Doc version: v1.8.0 | skeleton / SLICE-REF-GM-0 map sync | no concrete slice/test coverage claim | Tracks current slice/test refactor goal, audit gaps and pilot decision before first per-slice refactor. |
...
| `planning/workstreams/slice-test-source-refactor-goal-map.md` | slice/testing registers and versioned owner docs | Local workstream map now exists for audit/gap tracking before first concrete slice refactor. | map created / concrete slice coverage unsynchronized | Fill per-file audit cards before choosing SLICE-PILOT-1. |
