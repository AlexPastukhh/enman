...
After TM-REUSE-ONLY, this register records that the tracked Tampermonkey helper implementation moved fully into `planning/documentation/tools/tampermonkey/` and local `tools/tampermonkey/` files were removed from active tracked routing.
