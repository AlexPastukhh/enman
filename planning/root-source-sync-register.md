...
| `planning/workstreams/tampermonkey-command-projection-plan.md` | Tampermonkey command projection plan | Doc version: v0.4.0 | derived/synchronized in ROOT-FULL-1 and updated in SRC-CMD-1B helper profile pass | Defines helper prompt body projection model; local source sync section added; helper profiles remain projections. |
...
| `tools/tampermonkey/README.md` | Tampermonkey helper orientation | Doc version: v0.4.0 / implementation docs | derived/synchronized in ROOT-FULL-1 and updated in SRC-CMD-1B helper profile pass | Not command source of truth; local source sync section added. |
...
| `planning/workstreams/tampermonkey-command-projection-plan.md` | ROOT-FULL-1/SRC-CMD-1B-covered helper projection plan | Doc version: v0.4.0 | helper profiles added for source/version maintenance commands and `положняк` in SRC-CMD-1B | Refresh when command profiles/routes change. |
...
| `tools/tampermonkey/README.md` | ROOT-FULL-1/SRC-CMD-1B-covered helper implementation docs | Doc version: v0.4.0 | helper profile docs updated in SRC-CMD-1B | Not command source of truth. |
...
| `planning/documentation/field-kits/root-use-case-map-field-kit.md` | root UCM setup and profile-specific example-fit confirmation | `planning/documentation/examples/README.md`; `planning/documentation/use-case-map-workflow.md`; `planning/documentation/example-coverage-workflow.md`; `planning/planning-use-case-map.md` | setup/process + demonstration-fit rule | field kit Doc version: v0.1.0; examples README Doc version: v0.2.0; use-case workflow/example-coverage Doc version: v0.1.0; UCM Doc version: v1.0.0 | skeleton / CASCADE-ROUTE-1B limited file-level sync | no silent example-fit decision | Field kit must show candidate profile-specific examples to the user before wiring them into concrete root UCM routes. |
