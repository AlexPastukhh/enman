...
Status: initial structure / topic-first VKR drafting workflow  
...
| `03-chapter-2-design/` | Design chapter topics: scenarios, lifecycles, domain model, DB, architecture, API, UI |
| `04-chapter-3-implementation-and-testing/` | Implementation/testing topics and evidence |
