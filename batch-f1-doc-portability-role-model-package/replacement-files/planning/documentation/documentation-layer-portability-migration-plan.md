...
## 11. Portability Review Workflow Decision

A new workflow should eventually be added:

```text
documentation-layer-portability-review-workflow.md
```
...
5. Add portability-review workflow as a future owner or create it if approved.
...
- add/plan portability review workflow;
...
2. Should `documentation-layer-portability-review-workflow.md` be created before the candidate copy?
   - Pro: makes the review process reusable immediately.
   - Con: adds a new workflow before the candidate migration starts.
...
| Portability review workflow | process: how to classify text as reusable/specialized/project-specific/workflow/detail |
| Use-case map | optional route: if user asks to review docs for portability, activate the portability review workflow |
...
3. Add/prepare portability review workflow.
