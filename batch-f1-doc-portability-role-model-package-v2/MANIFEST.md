# Batch F1 — Documentation Portability Role Model Package v2

Status: corrected replacement package created  
Scope: pre-split documentation-layer portability role model and migration plan

## v2 corrections

This package fixes two review blockers found in the first pasted diff:

- `documentation-layer-portability-migration-plan.md` now references the accepted `documentation-responsibility-zone-review-workflow.md` instead of the older narrow `documentation-layer-portability-review-workflow.md` name.
- `examples/README.md` places deferred example rows inside the Example Coverage Table, not after the "Adding A New Example" section.
