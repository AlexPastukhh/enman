// Копия класса Error и предопределённых ошибок для отчёта.
// Файл находится в пространстве имён Docs.Report и служит только документации.

using System;
using System.Collections.Generic;
using CSharpFunctionalExtensions;

namespace Docs.Report
{
